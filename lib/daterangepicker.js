  ...
  // Finally, as a browser global.
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            this.oldStartDate = this.oldStartDate || this.startDate.clone();
            this.oldEndDate = this.oldEndDate || this.endDate.clone();
            this.oldChosenLabel = this.oldChosenLabel || this.chosenLabel;
        ...
        updateCalendars: function () {
            ...
            var container = $('.daterangepicker .ranges ul'),
                scrollTo = $('.daterangepicker .ranges ul .active'),
                scrollPosition = scrollTo.offset().top - container.offset().top + container.scrollTop();
